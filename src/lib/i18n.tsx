...
const dict = {
  ...
  script_label_simplified: { en: "Simplified", zh: "简体" },
  script_label_traditional: { en: "Traditional", zh: "繁體" },
  script_label_bilingual: { en: "Bilingual (CN/EN)", zh: "双语" },
  title_en_label: { en: "Title (English)", zh: "书名（English）" },
  title_zh_label: { en: "Title (中文)", zh: "书名（中文）" },
  author_en_label: { en: "Author (English)", zh: "作者（English）" },
  author_zh_label: { en: "Author (中文)", zh: "作者（中文）" },
  bilingual_hint: {
    en: "Bilingual book — please fill in both English and Chinese fields.",
    zh: "双语绘本 — 请同时填写中英文信息。",
  },
