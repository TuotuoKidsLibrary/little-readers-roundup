...
const dict = {
  ...
  membership_blurb: {
    en: "You're in free testing mode.",
    zh: "您正在使用免费测试版。",
  },
  ...
  cover_upload_hint: {
    en: "This book wasn't found automatically — add a photo of the cover so others can recognize it.",
    zh: "未能自动找到此书 — 请上传封面照片，方便大家识别。",
  },
  ...
  select_script_type: { en: "Select Script Type", zh: "选择字体" },
    ...
    script_bilingual: { en: "English & Chinese", zh: "中英双语" },
  ...
  batch_set_status: { en: "Set status", zh: "设置状态" },
  batch_set_script: { en: "Set script type", zh: "设置字体" },
  batch_set_age: { en: "Set age range", zh: "设置适用年龄" },
  delete_selected: { en: "Delete selected", zh: "删除所选" },
  batch_delete_confirm: {
    en: "Delete the selected books from your shelf? This cannot be undone.",
    zh: "确定要删除所选图书吗？此操作无法撤销。",
  },
  batch_saving: { en: "Saving…", zh: "保存中…" },
