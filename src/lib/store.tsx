...
const seedBooks: Book[] = [
  ...
  { id: "b3", title: "好饿的毛毛虫", author: "艾瑞·卡尔", isbn: "9787533256739", script_type: "Simplified", age_range: "0-2", status: "for_sale", price: 6, owner_id: CURRENT_USER_ID, owner_name: "You", cover_hue: 62 },
  { id: "b4", title: "三毛流浪记", author: "张乐平", isbn: "9787532429189", script_type: "Simplified", age_range: "6+", status: "donation", owner_id: "platform_admin", owner_name: "Library Collection", cover_hue: 8 },
  ...
  { id: "b6", title: "彩虹色的花", author: "麦克·格雷涅茨", isbn: "9787539130460", script_type: "Simplified", age_range: "3-5", status: "reserved", owner_id: "u_ling", owner_name: "Ling H.", cover_hue: 320 },
  ...
  { id: "b8", title: "西游记 (儿童版)", author: "吴承恩", isbn: "9787106002299", script_type: "Simplified", age_range: "6+", status: "donation", owner_id: "platform_admin", owner_name: "Library Collection", cover_hue: 48 },
];
